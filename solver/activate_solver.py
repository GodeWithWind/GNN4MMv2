...
import nni
import torch
from solver.loss import SumRateMM
            ...
            if args.use_log:
                ...
                self.record(
                    "VAL_INFO:epoch {},loss: {:.4f}".format(
                        epoch, val_loss))
            # 输出的太多了，所以分两次输出
            print("TRAIN_INFO:epoch {},loss: {:.4f}".format(epoch, train_loss))
            print("VAL_INFO:epoch {},loss: {:.4f}".format(epoch, val_loss))
